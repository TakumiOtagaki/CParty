...
int a_penalty = 339; // The newest value is from DP09 // misc.multi_offset; // penalty for introducing a multiloop (3.4 Kcal/mol)
int b_penalty =
    3; // The newest value is from DP09 // misc.multi_helix_penalty; // penalty for base pair in a multiloop (0.4 Kcal/mol)
int c_penalty =
    2; // The newest value is from DP09 // misc.multi_free_base_penalty; // penalty for un-paired base in a multi-loop
