...
class pseudo_loop {
  ...
  private:
    ...
    void back_track_wmb(seq_interval *cur_interval, sparse_tree &tree);
    ...
    void back_track_vp_case_1(cand_pos_t i, cand_pos_t j, sparse_tree &tree, cand_pos_t Bp_ij, cand_pos_t B_ij, cand_pos_t b_ij,
                              cand_pos_t bp_ij, int &min, int &best_row);
    void back_track_vp_case_2(cand_pos_t i, cand_pos_t j, sparse_tree &tree, cand_pos_t Bp_ij, cand_pos_t B_ij, cand_pos_t b_ij,
                              cand_pos_t bp_ij, int &min, int &best_row);
    void back_track_vp_case_3(cand_pos_t i, cand_pos_t j, sparse_tree &tree, cand_pos_t Bp_ij, cand_pos_t B_ij, cand_pos_t b_ij,
                              cand_pos_t bp_ij, int &min, int &best_row);
