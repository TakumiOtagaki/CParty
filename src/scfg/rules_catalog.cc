...
const RuleSpec kRuleSpecs[] = {
    ...
    rule_spec(RuleId::V_HAIRPIN,
              ...
              RuleSpec::PredicateKind::VPairingStateAndHairpinMinLoop),
    ...
    rule_spec(RuleId::WI_SPLIT_WMB,
              ...
              RuleSpec::SplitGenKind::KRange,
              split_range(Endpoint::I, 0, Endpoint::J, -1, true, true)),
    rule_spec(RuleId::WI_EXTEND_UNPAIRED,
              NonTerminal::WI,
              split_spec(SplitKind::None),
              kWiExtendUnpairedRhs,
              1,
              RuleSpec::SplitGenKind::Custom,
              {},
              RuleSpec::SplitFilterKind::None,
    ...
    // W
    rule_spec(RuleId::W_EXTEND_UNPAIRED,
              NonTerminal::W,
              split_spec(SplitKind::None),
              kWExtendUnpairedRhs,
              1,
    ...
    rule_spec(RuleId::WMv_EXTEND_UNPAIRED,
              NonTerminal::WMv,
              split_spec(SplitKind::None),
              nullptr,
              0,
              ...
              RuleSpec::SplitFilterKind::None,
              RuleSpec::PredicateKind::UnpairedAtJ),
    rule_spec(RuleId::WMp_EXTEND_UNPAIRED,
              NonTerminal::WMp,
              split_spec(SplitKind::None),
              nullptr,
              0,
    ...
    rule_spec(RuleId::WIP_SPLIT_WMB,
              ...
              RuleSpec::SplitGenKind::KRange,
              split_range(Endpoint::I, 1, Endpoint::J, -1, false, true)),
    rule_spec(RuleId::WIP_BASEPAIR_V,
              NonTerminal::WIP,
              split_spec(SplitKind::K),
              kWipBasepairVRhs,
              1,
              ...
              {},
              RuleSpec::SplitFilterKind::CanPairLeft),
    rule_spec(RuleId::WIP_BASEPAIR_WMB,
              NonTerminal::WIP,
              split_spec(SplitKind::K),
              kWipBasepairWmbRhs,
              1,
    ...
    rule_spec(RuleId::VP_WI_CASE1,
              NonTerminal::VP,
              split_spec(SplitKind::None, true, true),
              kVpWiCase1Rhs,
              2,
              RuleSpec::SplitGenKind::Custom,
              {},
              RuleSpec::SplitFilterKind::None,
              RuleSpec::PredicateKind::VpWiCase1),
    rule_spec(RuleId::VP_WI_CASE2,
              NonTerminal::VP,
              split_spec(SplitKind::None, true, true),
              kVpWiCase2Rhs,
              2,
              ...
              {},
              RuleSpec::SplitFilterKind::None,
              RuleSpec::PredicateKind::VpWiCase2),
    rule_spec(RuleId::VP_WI_CASE3,
              NonTerminal::VP,
              split_spec(SplitKind::None, true, true),
              kVpWiCase3Rhs,
              3,
              ...
              {},
              RuleSpec::SplitFilterKind::None,
              RuleSpec::PredicateKind::VpWiCase3),
    rule_spec(RuleId::VP_STACK,
              NonTerminal::VP,
              split_spec(SplitKind::None),
              kVpStackRhs,
              1,
              ...
              {},
              RuleSpec::SplitFilterKind::None,
              RuleSpec::PredicateKind::VpStackPairing),
    rule_spec(RuleId::VP_INTERNAL_LOOP,
              NonTerminal::VP,
    ...
    rule_spec(RuleId::VP_WIP_VP_LEFT,
              ...
              2,
              RuleSpec::SplitGenKind::BandMinBpRange),
    rule_spec(RuleId::VP_VP_WIP_RIGHT,
              NonTerminal::VP,
              split_spec(SplitKind::K),
              kVpVpWipRightRhs,
              2,
              RuleSpec::SplitGenKind::BandMaxBpRange),
    rule_spec(RuleId::VP_WIP_VPR,
              NonTerminal::VP,
              split_spec(SplitKind::K),
              kVpWipVprRhs,
              2,
              RuleSpec::SplitGenKind::BandMinBpRange),
    rule_spec(RuleId::VP_VPL_WIP,
              NonTerminal::VP,
              split_spec(SplitKind::K),
              kVpVplWipRhs,
              2,
    ...
    rule_spec(RuleId::WMB_SPLIT_BE_WMBP_WI, NonTerminal::WMB, split_spec(SplitKind::K, true, true),
              kWmbSplitBeWmbpWiRhs, 2, RuleSpec::SplitGenKind::Custom, {}, RuleSpec::SplitFilterKind::WmbBpRange,
    ...
    // BE
    rule_spec(RuleId::BE_BASE_SAMEPAIR,
              NonTerminal::BE,
              split_spec(SplitKind::None),
              nullptr,
              0,
    ...
    rule_spec(RuleId::BE_INTERNAL_LOOP,
              ...
              RuleSpec::SplitGenKind::Custom,
              {},
              RuleSpec::SplitFilterKind::BeSplitPairWithin,
