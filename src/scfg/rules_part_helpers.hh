#ifndef SCFG_RULES_PART_HELPERS_HH_
#define SCFG_RULES_PART_HELPERS_HH_
...
class PartFuncRuleHelpersView {
  public:
    PartFuncRuleHelpersView(const StructureView &view, const PartFuncModeConfig &config);

    cand_pos_t border_b(cand_pos_t i, cand_pos_t j) const;
    cand_pos_t border_bp(cand_pos_t i, cand_pos_t j) const;
    cand_pos_t border_B(cand_pos_t i, cand_pos_t j) const;
    cand_pos_t border_Bp(cand_pos_t i, cand_pos_t j) const;
    cand_pos_t pair_at(cand_pos_t pos) const;
    cand_pos_t parent_index(cand_pos_t pos) const;
    ...
    bool allow_exterior_split(cand_pos_t l, cand_pos_t j, cand_pos_t b_ij, int exterior_case) const;
    bool has_valid_band_borders(cand_pos_t i, cand_pos_t l, cand_pos_t j) const;
    bool parent_within_interval_and_turn(cand_pos_t i, cand_pos_t l, cand_pos_t j) const;
    bool has_valid_inner_arc_split(cand_pos_t i, cand_pos_t l, cand_pos_t j, cand_pos_t n_bound) const;
